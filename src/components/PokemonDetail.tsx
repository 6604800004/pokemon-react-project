      ...
      <div className="relative max-w-[1400px] mx-auto">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none -translate-y-[560px]">
          <div className="relative w-[28%] h-[28%]">
            ...
            />
            <span className="absolute -top-[55px] left-1/2 -translate-x-1/2 text-[#b3eafe] text-[39px] z-20">
              {data.id.toString().padStart(4, "0")}
            </span>
            <span
              className="absolute -top-[35px] left-1/2 -translate-x-1/2 text-[#ffffff] text-[68px] font-bold z-40 whitespace-nowrap"
              style={{
                textShadow:
